...
with lib.hm.gvariant;
{
  dconf.settings = {
    ...
    "org/gnome/desktop/wm/keybindings" = {
      ...
      switch-to-workspace-left = [ "<Super>z" ];
      switch-to-workspace-right = [ "<Super>x" ];
    };
    ...
    "org/gnome/shell" = {
      ...
      disabled-extensions = [];
      enabled-extensions = [ "caffeine@patapon.info" "user-theme@gnome-shell-extensions.gcampax.github.com" "unite@hardpixel.eu" "widgets@aylur" ];
      favorite-apps = [ "firefox.desktop" "org.gnome.Nautilus.desktop" "code.desktop" "ferdium.desktop" "Alacritty.desktop" ];
    };
